    ...
    <>
      <section className="text-white">
        ...
        <form>
          ...
          <input type="text" placeholder="digite o nome completo do autor(a)"/> <br />
          <label>Gênero:</label> <br />
          <input type="text" placeholder="insira o gênero do livro"/> <br />
          <label>Ano de lançamento:</label> <br />
          <input type="number" placeholder="insira o ano de lançamento"/> <br />
          <label>Link:</label> <br />
          <input type="text" placeholder="insira o link de download do livro"/> <br />
        </form>
      </section>
    </>
  )
